...
class RBTree():
    ...
    def __expressCall ( self , node , indent , last ) :
        ...
        if node != self.NULL :
            ...
            self.theExpression += str ( node.val ) + "(" + s_color + ")"
            #print ( str ( node.val ) + "(" + s_color + ")" )
            self.__expressCall ( node.left , indent , False )
            self.__expressCall ( node.right , indent , True )

    def express_tree (self) :
        self.theExpression = ""
        self.__expressCall ( self.root , "" , True )
